...
PAGES_BASE = '/hop-geometry-calculator-plugin/'
HANDBOOK = 'geometry-calculator/main/index.html'
HANDBOOK_ANCHORS = ['geometry-calculator', '_description', '_input', 'options', 'operations-table',
                    'output', '_supported_engines', '_examples', 'error-handling', 'limitations']
HPL_DOWNLOADS = 3
...
def check(root):
    ...
    for name in ['Geometry Calculator', 'Supported engines', 'Error handling']:
